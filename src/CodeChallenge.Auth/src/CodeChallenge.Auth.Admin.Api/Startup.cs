...
using CodeChallenge.Auth.Admin.Api.Configuration;
using CodeChallenge.Auth.Admin.Api.Configuration.Authorization;
using CodeChallenge.Auth.Admin.Api.Configuration.Constants;
using CodeChallenge.Auth.Admin.Api.ExceptionHandling;
using CodeChallenge.Auth.Admin.Api.Helpers;
using CodeChallenge.Auth.Admin.Api.Mappers;
using CodeChallenge.Auth.Admin.Api.Resources;
using CodeChallenge.Auth.Admin.EntityFramework.Shared.DbContexts;
using CodeChallenge.Auth.Admin.EntityFramework.Shared.Entities.Identity;
using CodeChallenge.Auth.Shared.Dtos;
using CodeChallenge.Auth.Shared.Dtos.Identity;
...
namespace CodeChallenge.Auth.Admin.Api
{

...
using CodeChallenge.Auth.STS.Identity.Configuration;
using CodeChallenge.Auth.STS.Identity.Configuration.ApplicationParts;
using CodeChallenge.Auth.STS.Identity.Configuration.Constants;
using CodeChallenge.Auth.STS.Identity.Configuration.Interfaces;
using CodeChallenge.Auth.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace CodeChallenge.Auth.STS.Identity.Helpers
{
